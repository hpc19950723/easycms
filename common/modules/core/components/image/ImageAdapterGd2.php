...
use common\modules\core\components\image\ImageAdapterAbstract;
use yii\base\Exception;
use yii\helpers\FileHelper;

class ImageAdapterGd2 extends ImageAdapterAbstract
{
    ...
    public function open($filename)
    {
        ...
        if ($this->_isMemoryLimitReached()) {
            throw new Exception('Memory limit has been reached.');
        }
